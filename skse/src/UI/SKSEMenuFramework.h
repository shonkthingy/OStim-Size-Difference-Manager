...
inline HMODULE MenuFrameworkHandle()
{
	if (HMODULE h = GetModuleHandleW(L"SKSEMenuFramework.dll")) {
		return h;
	}
	return GetModuleHandleA("SKSEMenuFramework.dll");
}
#define menuFramework MenuFrameworkHandle()
